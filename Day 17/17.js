...
// Activity 3: Queue
// Task 5: Implement a Queue class methods enqueue (add element), dequeue(remove element) and front (view the first element). 
...
// * Use stacks for LIFO(Last-In-First-Out) operations and reverersedata.
