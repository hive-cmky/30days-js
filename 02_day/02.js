...
const multiply = multiplication(num1, num2);
...
const remain = remainder(num1, num2);
console.log(remain);
...
// basic arithmetic oprations(addition, subtraction, multiplication, division, remainder) on two numbers and logs the results.
